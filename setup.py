"""
A setuptools based setup module for tracerepo.
See:
...
setup(
    ...
    name=package_name.replace("_", "-"),  # Required
    ...
    description="Trace data management",  # Optional
    ...
    keywords="data analysis spatial geology",  # Optional
    ...
    entry_points={"console_scripts": ["tracerepo=tracerepo.cli:app"]},  # Optional
